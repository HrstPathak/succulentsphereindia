module.exports=[24361,(e,t,r)=>{t.exports=e.x("util",()=>require("util"))},67417,e=>e.a(async(t,r)=>{try{e.i(23502);var i=e.i(66663),a=e.i(76680),o=t([i,a]);async function n(e){let t=await (0,a.getAuthenticatedCustomer)(e),r=String(t.customer?.email||"").trim().toLowerCase();return{...t,email:r,isAdmin:!!(r&&new Set(String(process.env.ADMIN_EMAILS||"").split(",").map(e=>e.trim().toLowerCase()).filter(Boolean)).has(r))}}async function d(){let e=await n();if(!e.uid)throw Error("UNAUTHENTICATED");if(!e.isAdmin)throw Error("ADMIN_REQUIRED");return e}[i,a]=o.then?(await o)():o,e.s(["getAdminSession",()=>n,"requireAdmin",()=>d]),r()}catch(e){r(e)}},!1),6461,(e,t,r)=>{t.exports=e.x("zlib",()=>require("zlib"))},88947,(e,t,r)=>{t.exports=e.x("stream",()=>require("stream"))},33405,(e,t,r)=>{t.exports=e.x("child_process",()=>require("child_process"))},21517,(e,t,r)=>{t.exports=e.x("http",()=>require("http"))},24836,(e,t,r)=>{t.exports=e.x("https",()=>require("https"))},46786,(e,t,r)=>{t.exports=e.x("os",()=>require("os"))},27699,(e,t,r)=>{t.exports=e.x("events",()=>require("events"))},54799,(e,t,r)=>{t.exports=e.x("crypto",()=>require("crypto"))},92509,(e,t,r)=>{t.exports=e.x("url",()=>require("url"))},4446,(e,t,r)=>{t.exports=e.x("net",()=>require("net"))},55004,(e,t,r)=>{t.exports=e.x("tls",()=>require("tls"))},88369,e=>e.a(async(t,r)=>{try{e.i(23502);var i=e.i(73051),a=e.i(74681),o=t([i]);function n(e){return String(e||"").replace(/[&<>'"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[e]||e)}function d(e){return new Intl.NumberFormat("en-IN",{style:"currency",currency:"INR",maximumFractionDigits:2}).format(e)}async function s(e){if(!(0,a.configuredEmailProvider)())return await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({emailStatus:"not_configured",emailUpdatedAt:new Date().toISOString()},{merge:!0}),{sent:!1,skipped:!0};try{let t,r,o,s,l,p,c,g,m,u=await (0,a.sendEmail)({to:e.customerEmail,subject:`Succulent Sphere — Order #${e.orderNumber} confirmed`,html:(t=e.items.map(e=>`
  ...
  </html>`}(e),idempotencyKey:`order-admin-notify-${e.orderId}-${t}`});await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({adminEmailStatus:"sent",adminEmailProvider:r.provider,adminEmailProviderId:r.id||"",adminEmailSentAt:new Date().toISOString()},{merge:!0})}catch(t){await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({adminEmailStatus:"failed",adminEmailError:String(t.message||t).slice(0,300),adminEmailUpdatedAt:new Date().toISOString()},{merge:!0})}return{sent:!0,skipped:!1}}catch(t){return await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({emailStatus:"failed",emailError:String(t.message||"Unable to send order email.").slice(0,300),emailUpdatedAt:new Date().toISOString()},{merge:!0}),{sent:!1,skipped:!1}}}async function l(e){if(!(0,a.configuredEmailProvider)())return{sent:!1,skipped:!0};let t=e.carrier||"Delhivery",r=e.trackingUrl||`https://www.delhivery.com/track/package/${encodeURIComponent(e.trackingNumber)}`,o=`<!doctype html><html><body style="margin:0;background:#f4f6f2;font-family:Arial,sans-serif;color:#20352a"><main style="max-width:620px;margin:28px auto;background:#fff;border:1px solid #e2e8e1;border-radius:20px;overflow:hidden"><header style="padding:30px;background:linear-gradient(135deg,#173c2d,#356649);color:#fff"><p style="margin:0;font-size:11px;font-weight:bold;letter-spacing:2px">SUCCULENT SPHERE</p><h1 style="margin:12px 0 0;font-size:28px">Your plants are on their way</h1></header><section style="padding:30px"><p style="font-size:16px">Hi ${n(e.customerName||"there")},</p><p>Great news — order <strong>#${n(e.orderNumber)}</strong> has been handed to ${n(t)}.</p><div style="margin:24px 0;padding:20px;border-radius:14px;background:#edf6ee;border:1px solid #d7ead9"><p style="margin:0 0 8px;font-size:11px;font-weight:bold;letter-spacing:1px;color:#54705c">TRACKING NUMBER</p><p style="margin:0;font-size:22px;font-weight:bold;color:#1d4a35">${n(e.trackingNumber)}</p></div><p style="margin:24px 0"><a href="${n(r)}" style="display:inline-block;background:#1d573b;color:#fff;text-decoration:none;padding:13px 20px;border-radius:10px;font-weight:bold">Track your shipment</a></p><p style="font-size:13px;line-height:1.6;color:#607267">The tracking page can take a little time to show its first scan after dispatch. Please keep this email for your reference.</p></section><footer style="padding:18px 30px;background:#f7f9f6;color:#718076;font-size:12px">Questions? Reply to this email and our plant team will help.</footer></main></body></html>`;try{let t=await (0,a.sendEmail)({to:e.customerEmail,subject:`Your Succulent Sphere order #${e.orderNumber} is on its way`,html:o,idempotencyKey:`tracking-${e.orderId}-${e.trackingNumber}`});return await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({trackingEmailStatus:"sent",trackingEmailProvider:t.provider,trackingEmailSentAt:new Date().toISOString()},{merge:!0}),{sent:!0,skipped:!1}}catch(t){return await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({trackingEmailStatus:"failed",trackingEmailError:String(t.message).slice(0,300),trackingEmailUpdatedAt:new Date().toISOString()},{merge:!0}),{sent:!1,skipped:!1}}}[i]=o.then?(await o)():o,e.s(["sendOrderConfirmationEmail",()=>s,"sendTrackingEmail",()=>l]),r()}catch(e){r(e)}},!1),67371,e=>e.a(async(t,r)=>{try{var i=e.i(89171),a=e.i(67417),o=e.i(73051),n=e.i(88369),d=e.i(10732),s=t([a,o,n,d]);async function l(e){try{await (0,a.requireAdmin)();let{id:t,fulfillmentStatus:r,financialStatus:s,trackingNumber:l,trackingUrl:p,carrier:c}=await e.json();if(!String(t||"").trim())return i.NextResponse.json({error:"Order id is required."},{status:400});let g=(0,o.getFirebaseDb)().collection("orders").doc(String(t)),m=await g.get();if(!m.exists)return i.NextResponse.json({error:"Order not found."},{status:404});let u={updatedAt:new Date().toISOString()};["UNFULFILLED","FULFILLED","DELIVERED","CANCELLED"].includes(String(r||"").toUpperCase())&&(u.fulfillmentStatus=String(r).toUpperCase()),["PENDING","PAID","REFUNDED"].includes(String(s||"").toUpperCase())&&(u.financialStatus=String(s).toUpperCase());let x=String(l||"").trim(),f=String(m.get("tracking")?.[0]?.number||"").trim();if(x&&(u.tracking=[{number:x,url:String(p||"").trim(),company:String(c||"Delhivery").trim()||"Delhivery"}]),1===Object.keys(u).length)return i.NextResponse.json({error:"Choose an order update."},{status:400});await g.set(u,{merge:!0});let y=String(u.fulfillmentStatus||"").toUpperCase(),b=String(u.financialStatus||"").toUpperCase();("CANCELLED"===y||"REFUNDED"===b)&&await (0,d.applyWalletOrderCancellationPolicy)(String(t));let h=!1;if(x&&x!==f){let e=m.data()||{},t=e.customer||{},r=String(e.emailLower||t.email||"").trim();/^\S+@\S+\.\S+$/.test(r)&&(h=(await (0,n.sendTrackingEmail)({orderId:m.id,orderNumber:Number(e.orderNumber||0),customerName:String(t.fullName||e.customerName||"Customer"),customerEmail:r,trackingNumber:x,trackingUrl:String(p||"").trim(),carrier:String(c||"Delhivery").trim()||"Delhivery"})).sent)}return i.NextResponse.json({ok:!0,trackingEmailSent:h})}catch(e){return i.NextResponse.json({error:"ADMIN_REQUIRED"===String(e.message)?"Not found.":e.message},{status:"ADMIN_REQUIRED"===String(e.message)?404:500})}}[a,o,n,d]=s.then?(await s)():s,e.s(["PATCH",()=>l]),r()}catch(e){r(e)}},!1),99217,e=>e.a(async(t,r)=>{try{var i=e.i(47909),a=e.i(74017),o=e.i(96250),n=e.i(59756),d=e.i(61916),s=e.i(74677),l=e.i(69741),p=e.i(16795),c=e.i(87718),g=e.i(95169),m=e.i(47587),u=e.i(66012),x=e.i(70101),f=e.i(26937),y=e.i(10372),b=e.i(93695);e.i(52474);var h=e.i(220),w=e.i(67371),v=t([w]);[w]=v.then?(await v)():v;let R=new i.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/admin/orders/route",pathname:"/api/admin/orders",filename:"route",bundlePath:""},distDir:".next-verify",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/admin/orders/route.ts",nextConfigOutput:"",userland:w}),{workAsyncStorage:N,workUnitAsyncStorage:k,serverHooks:$}=R;function E(){return(0,o.patchFetch)({workAsyncStorage:N,workUnitAsyncStorage:k})}async function S(e,t,r){R.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let i="/api/admin/orders/route";i=i.replace(/\/index$/,"")||"/";let o=await R.prepare(e,t,{srcPage:i,multiZoneDraftMode:!1});if(!o)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:w,params:v,nextConfig:E,parsedUrl:S,isDraftMode:N,prerenderManifest:k,routerServerContext:$,isOnDemandRevalidate:A,revalidateOnlyGenerated:D,resolvedPathname:C,clientReferenceManifest:I,serverActionsManifest:U}=o,O=(0,l.normalizeAppPath)(i),P=!!(k.dynamicRoutes[O]||k.routes[C]),z=async()=>((null==$?void 0:$.render404)?await $.render404(e,t,S,!1):t.end("This page could not be found"),null);if(P&&!N){let e=!!k.routes[C],t=k.dynamicRoutes[O];if(t&&!1===t.fallback&&!e){if(E.experimental.adapterPath)return await z();throw new b.NoFallbackError}}let _=null;!P||R.isDev||N||(_=C,_="/index"===_?"/":_);let T=!0===R.isDev||!P,q=P&&!T;U&&I&&(0,s.setManifestsSingleton)({page:i,clientReferenceManifest:I,serverActionsManifest:U});let M=e.method||"GET",F=(0,d.getTracer)(),L=F.getActiveScopeSpan(),j={params:v,prerenderManifest:k,renderOpts:{experimental:{authInterrupts:!!E.experimental.authInterrupts},cacheComponents:!!E.cacheComponents,supportsDynamicResponse:T,incrementalCache:(0,n.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:E.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,i,a)=>R.onRequestError(e,t,i,a,$)},sharedContext:{buildId:w}},H=new p.NodeNextRequest(e),K=new p.NodeNextResponse(t),B=c.NextRequestAdapter.fromNodeNextRequest(H,(0,c.signalFromNodeResponse)(t));try{let o=async e=>R.handle(B,j).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=F.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==g.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${M} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t)}else e.updateName(`${M} ${i}`)}),s=!!(0,n.getRequestMeta)(e,"minimalMode"),l=async n=>{var d,l;let p=async({previousCacheEntry:a})=>{try{if(!s&&A&&D&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await o(n);e.fetchMetrics=j.renderOpts.fetchMetrics;let d=j.renderOpts.pendingWaitUntil;d&&r.waitUntil&&(r.waitUntil(d),d=void 0);let l=j.renderOpts.collectedTags;if(!P)return await (0,u.sendResponse)(H,K,i,j.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,x.toNodeOutgoingHttpHeaders)(i.headers);l&&(t[y.NEXT_CACHE_TAGS_HEADER]=l),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==j.renderOpts.collectedRevalidate&&!(j.renderOpts.collectedRevalidate>=y.INFINITE_CACHE)&&j.renderOpts.collectedRevalidate,a=void 0===j.renderOpts.collectedExpire||j.renderOpts.collectedExpire>=y.INFINITE_CACHE?void 0:j.renderOpts.collectedExpire;return{value:{kind:h.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==a?void 0:a.isStale)&&await R.onRequestError(e,t,{routerKind:"App Router",routePath:i,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:A})},!1,$),t}},c=await R.handleResponse({req:e,nextConfig:E,cacheKey:_,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:k,isRoutePPREnabled:!1,isOnDemandRevalidate:A,revalidateOnlyGenerated:D,responseGenerator:p,waitUntil:r.waitUntil,isMinimalMode:s});if(!P)return null;if((null==c||null==(d=c.value)?void 0:d.kind)!==h.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",A?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),N&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let g=(0,x.fromNodeOutgoingHttpHeaders)(c.value.headers);return s&&P||g.delete(y.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||g.get("Cache-Control")||g.set("Cache-Control",(0,f.getCacheControlHeader)(c.cacheControl)),await (0,u.sendResponse)(H,K,new Response(c.value.body,{headers:g,status:c.value.status||200})),null};L?await l(L):await F.withPropagatedContext(e.headers,()=>F.trace(g.BaseServerSpan.handleRequest,{spanName:`${M} ${i}`,kind:d.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},l))}catch(t){if(t instanceof b.NoFallbackError||await R.onRequestError(e,t,{routerKind:"App Router",routePath:O,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:A})},!1,$),P)throw t;return await (0,u.sendResponse)(H,K,new Response(null,{status:500})),null}}e.s(["handler",()=>S,"patchFetch",()=>E,"routeModule",()=>R,"serverHooks",()=>$,"workAsyncStorage",()=>N,"workUnitAsyncStorage",()=>k]),r()}catch(e){r(e)}},!1)];

//# sourceMappingURL=%5Broot-of-the-server%5D__b8ce4db8._.js.map