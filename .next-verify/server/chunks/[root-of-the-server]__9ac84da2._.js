        ...
        <div style="border-radius:22px;background:linear-gradient(135deg,#ffffff,#f8faf5);border:1px solid #e1e8df;box-shadow:0 18px 40px rgba(20,38,28,0.08);overflow:hidden">
          ...
          <div style="padding:28px">
            ...
            <div style="padding-top:4px">
              <a href="${n(m)}" style="display:inline-block;background:#1d4c38;color:#fff;text-decoration:none;padding:12px 18px;border-radius:10px;font-weight:bold">Open in Admin</a>
            </div>
          </div>
        </div>
      </div>
    </body>
  </html>`}(e),idempotencyKey:`order-admin-notify-${e.orderId}-${t}`});await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({adminEmailStatus:"sent",adminEmailProvider:r.provider,adminEmailProviderId:r.id||"",adminEmailSentAt:new Date().toISOString()},{merge:!0})}catch(t){await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({adminEmailStatus:"failed",adminEmailError:String(t.message||t).slice(0,300),adminEmailUpdatedAt:new Date().toISOString()},{merge:!0})}return{sent:!0,skipped:!1}}catch(t){return await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({emailStatus:"failed",emailError:String(t.message||"Unable to send order email.").slice(0,300),emailUpdatedAt:new Date().toISOString()},{merge:!0}),{sent:!1,skipped:!1}}}async function l(e){if(!(0,a.configuredEmailProvider)())return{sent:!1,skipped:!0};let t=e.carrier||"Delhivery",r=e.trackingUrl||`https://www.delhivery.com/track/package/${encodeURIComponent(e.trackingNumber)}`,o=`<!doctype html><html><body style="margin:0;background:#f4f6f2;font-family:Arial,sans-serif;color:#20352a"><main style="max-width:620px;margin:28px auto;background:#fff;border:1px solid #e2e8e1;border-radius:20px;overflow:hidden"><header style="padding:30px;background:linear-gradient(135deg,#173c2d,#356649);color:#fff"><p style="margin:0;font-size:11px;font-weight:bold;letter-spacing:2px">SUCCULENT SPHERE</p><h1 style="margin:12px 0 0;font-size:28px">Your plants are on their way</h1></header><section style="padding:30px"><p style="font-size:16px">Hi ${n(e.customerName||"there")},</p><p>Great news — order <strong>#${n(e.orderNumber)}</strong> has been handed to ${n(t)}.</p><div style="margin:24px 0;padding:20px;border-radius:14px;background:#edf6ee;border:1px solid #d7ead9"><p style="margin:0 0 8px;font-size:11px;font-weight:bold;letter-spacing:1px;color:#54705c">TRACKING NUMBER</p><p style="margin:0;font-size:22px;font-weight:bold;color:#1d4a35">${n(e.trackingNumber)}</p></div><p style="margin:24px 0"><a href="${n(r)}" style="display:inline-block;background:#1d573b;color:#fff;text-decoration:none;padding:13px 20px;border-radius:10px;font-weight:bold">Track your shipment</a></p><p style="font-size:13px;line-height:1.6;color:#607267">The tracking page can take a little time to show its first scan after dispatch. Please keep this email for your reference.</p></section><footer style="padding:18px 30px;background:#f7f9f6;color:#718076;font-size:12px">Questions? Reply to this email and our plant team will help.</footer></main></body></html>`;try{let t=await (0,a.sendEmail)({to:e.customerEmail,subject:`Your Succulent Sphere order #${e.orderNumber} is on its way`,html:o,idempotencyKey:`tracking-${e.orderId}-${e.trackingNumber}`});return await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({trackingEmailStatus:"sent",trackingEmailProvider:t.provider,trackingEmailSentAt:new Date().toISOString()},{merge:!0}),{sent:!0,skipped:!1}}catch(t){return await (0,i.getFirebaseDb)().collection("orders").doc(e.orderId).set({trackingEmailStatus:"failed",trackingEmailError:String(t.message).slice(0,300),trackingEmailUpdatedAt:new Date().toISOString()},{merge:!0}),{sent:!1,skipped:!1}}}[i]=o.then?(await o)():o,e.s(["sendOrderConfirmationEmail",()=>s,"sendTrackingEmail",()=>l]),r()}catch(e){r(e)}},!1),49594,e=>e.a(async(t,r)=>{try{var i=e.i(89171),a=e.i(67417),o=e.i(73051),n=e.i(88369),d=t([a,o,n]);async function s(e){try{await (0,a.requireAdmin)();let{id:t}=await e.json();if(!t)return i.NextResponse.json({error:"order id required"},{status:400});let r=(0,o.getFirebaseDb)(),d=await r.collection("orders").doc(String(t)).get();if(!d.exists)return i.NextResponse.json({error:"Order not found"},{status:404});let s=d.data()||{},l={orderId:d.id,orderNumber:Number(s.orderNumber||0),customerName:s.customer?.fullName||s.customer?.name||"Customer",customerEmail:s.customer?.email||s.emailLower||"",items:(s.lineItems||[]).map(e=>({title:e.title,quantity:e.quantity,price:e.price?.amount||e.price,image:e.image,imageAlt:e.imageAlt})),total:Number(s.totalPrice?.amount||s.total||0),paymentMode:s.paymentMode||"prepaid",address:s.customer?.address1||s.customer?.address||"",city:s.customer?.city||s.customer?.province||"",state:s.customer?.state||s.customer?.province||"",pincode:s.customer?.zip||s.customer?.pincode||"",phone:s.customer?.phone||"",shipping:Number(s.shipping||0),discount:Number(s.discount||0),codFee:Number(s.codFee||0),paymentReceived:Number(s.paymentReceived||s.razorpayAmount||s.currentTotalPrice?.amount||0)},p=await (0,n.sendOrderConfirmationEmail)(l);return i.NextResponse.json({ok:!0,result:p})}catch(e){return i.NextResponse.json({error:String(e.message||e)},{status:500})}}[a,o,n]=d.then?(await d)():d,e.s(["POST",()=>s]),r()}catch(e){r(e)}},!1),45142,e=>e.a(async(t,r)=>{try{var i=e.i(47909),a=e.i(74017),o=e.i(96250),n=e.i(59756),d=e.i(61916),s=e.i(74677),l=e.i(69741),p=e.i(16795),c=e.i(87718),m=e.i(95169),u=e.i(47587),g=e.i(66012),x=e.i(70101),f=e.i(26937),y=e.i(10372),b=e.i(93695);e.i(52474);var h=e.i(220),v=e.i(49594),w=t([v]);[v]=w.then?(await w)():w;let S=new i.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/admin/orders/resend-confirmation/route",pathname:"/api/admin/orders/resend-confirmation",filename:"route",bundlePath:""},distDir:".next-verify",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/admin/orders/resend-confirmation/route.ts",nextConfigOutput:"",userland:v}),{workAsyncStorage:N,workUnitAsyncStorage:$,serverHooks:k}=S;function E(){return(0,o.patchFetch)({workAsyncStorage:N,workUnitAsyncStorage:$})}async function R(e,t,r){S.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let i="/api/admin/orders/resend-confirmation/route";i=i.replace(/\/index$/,"")||"/";let o=await S.prepare(e,t,{srcPage:i,multiZoneDraftMode:!1});if(!o)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:v,params:w,nextConfig:E,parsedUrl:R,isDraftMode:N,prerenderManifest:$,routerServerContext:k,isOnDemandRevalidate:A,revalidateOnlyGenerated:C,resolvedPathname:I,clientReferenceManifest:D,serverActionsManifest:O}=o,P=(0,l.normalizeAppPath)(i),z=!!($.dynamicRoutes[P]||$.routes[I]),T=async()=>((null==k?void 0:k.render404)?await k.render404(e,t,R,!1):t.end("This page could not be found"),null);if(z&&!N){let e=!!$.routes[I],t=$.dynamicRoutes[P];if(t&&!1===t.fallback&&!e){if(E.experimental.adapterPath)return await T();throw new b.NoFallbackError}}let _=null;!z||S.isDev||N||(_=I,_="/index"===_?"/":_);let U=!0===S.isDev||!z,q=z&&!U;O&&D&&(0,s.setManifestsSingleton)({page:i,clientReferenceManifest:D,serverActionsManifest:O});let M=e.method||"GET",j=(0,d.getTracer)(),F=j.getActiveScopeSpan(),H={params:w,prerenderManifest:$,renderOpts:{experimental:{authInterrupts:!!E.experimental.authInterrupts},cacheComponents:!!E.cacheComponents,supportsDynamicResponse:U,incrementalCache:(0,n.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:E.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,i,a)=>S.onRequestError(e,t,i,a,k)},sharedContext:{buildId:v}},L=new p.NodeNextRequest(e),K=new p.NodeNextResponse(t),B=c.NextRequestAdapter.fromNodeNextRequest(L,(0,c.signalFromNodeResponse)(t));try{let o=async e=>S.handle(B,H).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=j.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==m.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${M} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t)}else e.updateName(`${M} ${i}`)}),s=!!(0,n.getRequestMeta)(e,"minimalMode"),l=async n=>{var d,l;let p=async({previousCacheEntry:a})=>{try{if(!s&&A&&C&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await o(n);e.fetchMetrics=H.renderOpts.fetchMetrics;let d=H.renderOpts.pendingWaitUntil;d&&r.waitUntil&&(r.waitUntil(d),d=void 0);let l=H.renderOpts.collectedTags;if(!z)return await (0,g.sendResponse)(L,K,i,H.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,x.toNodeOutgoingHttpHeaders)(i.headers);l&&(t[y.NEXT_CACHE_TAGS_HEADER]=l),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==H.renderOpts.collectedRevalidate&&!(H.renderOpts.collectedRevalidate>=y.INFINITE_CACHE)&&H.renderOpts.collectedRevalidate,a=void 0===H.renderOpts.collectedExpire||H.renderOpts.collectedExpire>=y.INFINITE_CACHE?void 0:H.renderOpts.collectedExpire;return{value:{kind:h.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==a?void 0:a.isStale)&&await S.onRequestError(e,t,{routerKind:"App Router",routePath:i,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:A})},!1,k),t}},c=await S.handleResponse({req:e,nextConfig:E,cacheKey:_,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:$,isRoutePPREnabled:!1,isOnDemandRevalidate:A,revalidateOnlyGenerated:C,responseGenerator:p,waitUntil:r.waitUntil,isMinimalMode:s});if(!z)return null;if((null==c||null==(d=c.value)?void 0:d.kind)!==h.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",A?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),N&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let m=(0,x.fromNodeOutgoingHttpHeaders)(c.value.headers);return s&&z||m.delete(y.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||m.get("Cache-Control")||m.set("Cache-Control",(0,f.getCacheControlHeader)(c.cacheControl)),await (0,g.sendResponse)(L,K,new Response(c.value.body,{headers:m,status:c.value.status||200})),null};F?await l(F):await j.withPropagatedContext(e.headers,()=>j.trace(m.BaseServerSpan.handleRequest,{spanName:`${M} ${i}`,kind:d.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},l))}catch(t){if(t instanceof b.NoFallbackError||await S.onRequestError(e,t,{routerKind:"App Router",routePath:P,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:A})},!1,k),z)throw t;return await (0,g.sendResponse)(L,K,new Response(null,{status:500})),null}}e.s(["handler",()=>R,"patchFetch",()=>E,"routeModule",()=>S,"serverHooks",()=>k,"workAsyncStorage",()=>N,"workUnitAsyncStorage",()=>$]),r()}catch(e){r(e)}},!1)];

//# sourceMappingURL=%5Broot-of-the-server%5D__9ac84da2._.js.map