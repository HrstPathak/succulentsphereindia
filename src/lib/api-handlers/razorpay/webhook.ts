 ...
 * IMPORTANT: This handler reads the raw request body via request.text() and
 * performs HMAC verification BEFORE JSON parsing. The dispatcher must never
 * consume the body before this handler is invoked.
 */
